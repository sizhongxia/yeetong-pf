...
@Configuration
@MapperScan(basePackages = "org.yeetong.rpc.service.dao.todo", sqlSessionFactoryRef = "todoSqlSessionTemplate")
public class TodoDataSourceConfig {

	@Value("${spring.datasource.todo.url}")
	private String url;
	@Value("${spring.datasource.todo.username}")
	private String user;
	@Value("${spring.datasource.todo.password}")
	 ...
	 * @return
	 */
	@Bean(name = "todoTransationManager")
	 ...
	 * @throws Exception
	 */
	@Bean(name = "todoSqlSessionTemplate")
